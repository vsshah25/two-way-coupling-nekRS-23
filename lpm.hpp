...
public:
  ...
  // Moves mesh particles to the processor able to evaluate them
  void migrateTransfer();

  // Moves mesh particles to the processor able toapply the force
  void migrateBack();
  ...
  // Number of mesh particles that cannot be processed on the current rank
  int numNonLocalParticlesTransfer();

  // Number of mesh particles that need to be sent back
  int numNonLocalParticlesBack();
